...
const { empresa, segmento, ticket, tipo, transcricao, nome, email, empresaLead, cargo, faturamento, vendedores } = body;
    ...
    body: JSON.stringify({
      ...
      html: `
        ...
        <ul>
          ...
          <li><strong>Faturamento anual:</strong> ${faturamento||'—'}</li>
          <li><strong>Vendedores:</strong> ${vendedores||'—'}</li>
        </ul>
